...
<head>
    ...
    <title>Classification - Galaxy Runners</title>
...
<body onload="onLoadClassification()">
<div id="wrapper">
    <div id="content">
        ...
        <div class="page-content">
            <div class="events-container">
                ...
                <div id="text" class="buttons">
                    <button onclick="onClickGeneral()">General</button>
                    <button onclick="onClickFemale()">Female</button>
                    <button onclick="onClickMale()">Male</button>
                </div>
                ${general}
                ${female}
                ${male}
