...
<head>
    ...
    <title>Track Participants - Galaxy Runners</title>
    ...
    <div id="content">
        ...
        <div class="page-content">
            <div class="events-container">
                <h2>${event}</h2>
                <div id="text" class="buttons">
                    <button onclick="onClickSection('start')">Start</button>
                    <button onclick="onClickSection('p1')">P1</button>
                    <button onclick="onClickSection('p2')">P2</button>
                    <button onclick="onClickSection('p3')">P3</button>
                    <button onclick="onClickSection('finish')">Finish</button>
                </div>
                ${start}
                ${p1}
                ${p2}
